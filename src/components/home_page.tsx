        ...
        <div className="space-y-8">
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
              <div className="text-gray-700">dylansantiagorodriguez.p@gmail.com</div>
              <div className="text-gray-700">3168895127</div>
              ...
              <div className="text-gray-700">GitHub: DylanSantiagoRodriguez</div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="w-12 h-12 text-teal-500">
