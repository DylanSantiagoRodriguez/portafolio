    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div>
            <h2 className="text-lg font-medium mb-2">Ingeniero de software</h2>
            <h1 className="text-2xl font-bold mb-6">Dylan Santiago Rodríguez Portilla</h1>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-6 mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            tengo un nivel b2 en ingles, con certificación en CILT y diploma de eficiencia en ingles xprt universidad de
            nariño.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="bg-gray-50 rounded-lg p-6">
            <h2 className="text-xl font-bold mb-4">Descargar CV</h2>
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <h2 className="text-xl font-bold mb-4">Mis Conocimientos</h2>
