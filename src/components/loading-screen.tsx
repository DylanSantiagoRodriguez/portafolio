...
export default function LoadingScreen() {
  return (
    <main className="relative min-h-screen w-full bg-white overflow-hidden flex items-center justify-center">
      ...
      {/* Tarjeta central */}
      <article className="bg-white opacity-80 rounded-lg shadow-lg p-10 w-full max-w-2/4 mx-auto z-10">
        <header className="text-center">
          <h1 className="text-5xl font-bold text-teal-500 mb-4">Soy Dylan Rodríguez</h1>
